...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="btn btn-primary" onclick="window.location.href='{{url('developer/crashes#')}}{{$crash->id}}'">< Go Back</div>
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form method="POST" action="{{url('developer/crash/update')}}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-5">
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        ...
                        <div class="content">
                            ...
                            @if($crash->developer()->first()->id == Auth::user()->developer()->first()->id)
                                <a href="#pablo" class="btn btn-primary btn-round">Unassign Myself</a>
                            @else
                            @endif
                        </div>
                    </div>
