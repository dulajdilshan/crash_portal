...
Route::get('developer/crash/{id}','DeveloperController@editCrash')->middleware(AuthDeveloper::class);
Route::post('developer/send','DeveloperController@send');
Route::post('developer/crash/update','CrashController@updateCrash')->middleware(AuthDeveloper::class);;
Route::post('/developer/update-profile','DeveloperController@updateDeveloper');
Route::post('developer/assign-myself','DeveloperController@assignMyself');
...
Route::post('admin/crash/update','CrashController@updateCrash')->middleware(AuthAdmin::class);;
